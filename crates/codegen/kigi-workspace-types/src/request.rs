...
//!   here would force every consumer of `kigi-workspace-types`
...
//! (`kigi-workspace`) wraps this in its own `Request<T>` that
//! adds the cancellation token and extensions map.
//!
//! Splitting the envelope this way keeps `kigi-workspace-types`
