...
/// Wire-safe hunk action enum. Maps to `kigi_hunk_tracker::types::HunkAction`
...
/// Wire mirror of `kigi_hunk_tracker::types::HunkLineInfo`.
...
/// Wire mirror of `kigi_hunk_tracker::types::HunkSource`.
///
...
/// Wire mirror of `kigi_hunk_tracker::types::FileContentStatus`.
///
...
/// Wire mirror of `kigi_hunk_tracker::types::FileContentView`.
#[derive(Debug, Clone, Default, Serialize, Deserialize)]
#[serde(rename_all = "camelCase")]
...
/// Wire mirror of `kigi_hunk_tracker::types::FileContentEntry`.
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(rename_all = "camelCase")]
...
/// Wire mirror of `kigi_hunk_tracker::types::SessionStats`.
#[derive(Debug, Clone, Default, Serialize, Deserialize)]
#[serde(rename_all = "camelCase")]
...
/// Wire mirror of `kigi_hunk_tracker::types::TurnSummary`.
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(rename_all = "camelCase")]
...
/// Wire mirror of `kigi_hunk_tracker::types::SessionSummary`.
#[derive(Debug, Clone, Default, Serialize, Deserialize)]
#[serde(rename_all = "camelCase")]
