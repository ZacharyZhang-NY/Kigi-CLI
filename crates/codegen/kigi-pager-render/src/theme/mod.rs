...
impl Theme {
    ...
    ///
    /// Reads the active theme kind (loaded from `~/.kigi/config.toml` on
    ...
    pub fn current() -> Self {
        ...
        //      (e.g., `TERM=xterm`, `TERM=ansi`, or `KIGI_FORCE_COLOR_LEVEL=basic`),
...
pub fn apply_cursor_color() {
    ...
    kigi_shared::stderr::with_locked_stderr(|stderr| {
