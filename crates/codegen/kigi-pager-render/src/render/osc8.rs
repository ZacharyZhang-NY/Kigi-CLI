...
//! frame diff (see `kigi_ratatui_inline::Terminal::flush_with_links`).
...
/// Relative file path (`images/1.png`, `.kigi/x.txt`) — one or more `/`-joined
...
mod tests {
    ...
    fn scan_detects_kigi_session_media_path() {
        ...
        assert_eq!(
            ...
            "file:///Users/alice/.kigi/sessions/%252Fabc/00000000/images/1.jpg",
        );
    }
    ...
    fn scan_detects_media_path_soft_wrapped_across_rows() {
        ...
        let row0 =
            make_line("Image generated and saved to /Users/alice/.kigi/sessions/%2FUsers%2Fali");
        ...
        let expected_url = "file:///Users/alice/.kigi/sessions/%252FUsers%252Fali\
        ...
        assert_eq!(
            ...
            2 + UnicodeWidthStr::width(
                "Image generated and saved to /Users/alice/.kigi/sessions/%2FUsers%2Fali"
            ) as u16
        );
    ...
    fn scan_wrapped_path_trailing_sentence_period_excluded() {
        ...
        let row0 = make_line("Saved to /Users/me/.kigi/sessions/%2Fabc/019f3a86/ima");
        ...
        for link in overlay.links() {
            assert_eq!(
                &*link.url,
                "file:///Users/me/.kigi/sessions/%252Fabc/019f3a86/images/1.jpg"
            );
        }
    ...
    fn scan_relative_path_not_partially_linkified() {
        // A relative path like `crates/codegen/kigi-tui/src/render` should
        // NOT produce a link for the `/kigi-tui/src/render` substring.
        let line = make_line("find crates/codegen/kigi-tui/src/render -name '*.rs'");
        let mut overlay = LinkOverlay::new();
        scan_unjoined(std::iter::once((0, &line)), 0, &[], &mut overlay);
