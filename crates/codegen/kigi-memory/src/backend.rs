...
use kigi_tools::types::memory_backend::{MemoryBackend, MemorySearchResult};
...
pub struct MemoryBackendParams {
    ...
    pub search_config: kigi_config_types::MemorySearchConfig,
...
pub struct MemoryBackendImpl {
    ...
    embed_config: Option<kigi_config_types::MemoryEmbeddingConfig>,
    ...
    search_config: kigi_config_types::MemorySearchConfig,
...
impl MemoryBackendImpl {
    ...
    pub fn new(db_path: PathBuf, storage: MemoryStorage) -> Self {
        Self {
            ...
            embed_api_key: None,
            search_config: kigi_config_types::MemorySearchConfig::default(),
            watcher: None,
            stale_claim_secs: 60,
    ...
    pub fn with_embedding(
        mut self,
        config: kigi_config_types::MemoryEmbeddingConfig,
        base_url: String,
    ...
    pub fn with_search_config(mut self, config: kigi_config_types::MemorySearchConfig) -> Self {
    ...
    fn open_readonly(&self) -> Result<rusqlite::Connection, rusqlite::Error> {
        ...
        kigi_sqlite_journal::JournalMode::for_db_path(&self.db_path).open_readonly(&self.db_path)
    }
...
impl MemoryBackendImpl {
    ...
    pub fn search_config_for_test(&self) -> &kigi_config_types::MemorySearchConfig {
        &self.search_config
    }
}
...
impl MemoryBackend for MemoryBackendImpl {
    ...
    async fn search(
        ...
        let mut index = super::index::MemoryIndex::open_or_create(
            &self.db_path,
            self.storage.clone(),
            kigi_config_types::MemoryIndexConfig::default(),
            embed_dims,
        )
            ...
            && index.try_claim_reindex(self.stale_claim_secs)
        {
            ...
            for file in &dirty_files {
                if file.exists() {
                    ...
                    let _ = index.reindex_file(file, source);
                } else {
...
mod factory_tests {
    ...
    use kigi_config_types::{MemoryEmbeddingConfig, MemorySearchConfig};
    ...
    fn test_factory_wires_non_overridable_search_config_fields() {
        ...
        let custom_search = MemorySearchConfig {
            max_results: 7,
            mmr: kigi_config_types::MmrConfig {
                enabled: true,
                lambda: 0.42,
            },
            temporal_decay: kigi_config_types::TemporalDecayConfig {
                enabled: true,
                half_life_days: 14.0,
            },
            ..Default::default()
