...
impl kigi_tool_runtime::Tool for HashlineEditTool {
    ...
    async fn run(
    ...
    ) -> Result<crate::types::output::SearchReplaceOutput, kigi_tool_runtime::ToolError> {
        ...
        let (cwd, display_cwd, fs, scheme, hints_enabled) = {
            ...
            let cwd = match ctx.extensions.get::<kigi_tool_runtime::Cwd>() {
