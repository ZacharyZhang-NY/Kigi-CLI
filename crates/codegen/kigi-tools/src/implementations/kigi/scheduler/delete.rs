...
impl kigi_tool_runtime::ToolOutput for SchedulerDeleteOutput {}
...
impl kigi_tool_runtime::Tool for SchedulerDeleteTool {
    type Args = SchedulerDeleteInput;
    type Output = SchedulerDeleteOutput;

    fn id(&self) -> kigi_tool_protocol::ToolId {
        kigi_tool_protocol::ToolId::new("scheduler_delete").expect("valid tool id")
    }
    ...
    ) -> Result<SchedulerDeleteOutput, kigi_tool_runtime::ToolError> {
