...
impl kigi_tool_runtime::ToolOutput for SchedulerListOutput {}
...
impl crate::types::tool_metadata::ToolMetadata for SchedulerListTool {
    ...
    fn requires_expr(&self) -> Expr<ToolRequirement> {
        ...
        Expr::Value(ToolRequirement::Tool {
            ...
            id: kigi_tool_runtime::Tool::id(&SchedulerCreateTool).to_string(),
            if_params: None,
        })
    }
}

impl kigi_tool_runtime::Tool for SchedulerListTool {
    type Args = SchedulerListInput;
    type Output = SchedulerListOutput;

    fn id(&self) -> kigi_tool_protocol::ToolId {
        kigi_tool_protocol::ToolId::new("scheduler_list").expect("valid tool id")
    }
    ...
    ) -> Result<SchedulerListOutput, kigi_tool_runtime::ToolError> {
        ...
        sender
            ...
            .map_err(|_| {
                kigi_tool_runtime::ToolError::execution(
                    kigi_tool_protocol::ToolId::new("scheduler_list").expect("valid"),
