...
pub fn stream_responses<'a>(
    ...
    async_stream::stream! {
        ...
        let mut items = kigi_sampling_types::response_to_conversation_items(response);
        kigi_sampling_types::inject_streaming_reasoning_fallback(&mut items, reasoning_acc);
