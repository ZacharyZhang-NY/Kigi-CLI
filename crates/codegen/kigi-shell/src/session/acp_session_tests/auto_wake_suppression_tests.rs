...
use kigi_tools::reminders::task_completion::consumed_completion_ids;
use kigi_tools::types::output::{BashOutput, TextOutput, ToolOutput};
...
async fn already_reported(actor: &SessionActor, task_id: &str) -> bool {
    use kigi_tools::reminders::task_completion::ReportedTaskCompletions;
...
struct OneTaskTerminal {
    tasks: Vec<kigi_tools::computer::types::TaskSnapshot>,
}
#[async_trait::async_trait]
impl kigi_tools::computer::types::TerminalBackend for OneTaskTerminal {
    async fn run(
        &self,
        _: kigi_tools::computer::types::TerminalRunRequest,
    ) -> Result<
        kigi_tools::computer::types::TerminalRunResult,
        kigi_tools::computer::types::ComputerError,
    > {
        unimplemented!()
    }
    ...
    async fn get_task(&self, _: &str) -> Option<kigi_tools::computer::types::TaskSnapshot> {
        None
    }
    async fn kill_task(&self, _: &str) -> kigi_tools::computer::types::KillOutcome {
        kigi_tools::computer::types::KillOutcome::NotFound
    }
    async fn wait_for_completion(
        &self,
        _: &str,
        _: Option<std::time::Duration>,
    ) -> Option<kigi_tools::computer::types::TaskSnapshot> {
        None
    }
    async fn list_tasks(&self) -> Vec<kigi_tools::computer::types::TaskSnapshot> {
        self.tasks.clone()
    }
}
fn completed_bash_task(id: &str) -> kigi_tools::computer::types::TaskSnapshot {
    kigi_tools::computer::types::TaskSnapshot {
        task_id: id.into(),
