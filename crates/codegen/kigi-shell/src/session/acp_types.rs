...
impl TokenUsageCategory {
    ...
    pub fn skills_listing(text: &str, skill_count: usize) -> Self {
        Self {
            ...
            tokens: kigi_token_estimation::estimate_tokens(text),
...
impl ContextInfo {
    ...
    pub fn from_notification(used: u64, total: u64) -> Self {
        Self {
            used,
            total,
            usage_pct: kigi_token_estimation::usage_percentage_u8(used, total),
            free_tokens: kigi_token_estimation::free_tokens(total, used),
