...
//! window containing a [`kigi_mcp::servers::McpClientEventKind::TransportClosed`]
//! or [`kigi_mcp::servers::McpClientEventKind::HandshakeFailed`] key for a
...
//!    [`kigi_mcp::servers::start_mcp_server`] sets
...
//!    push and stop.
//! 5. **Already-Empty** — see the [`kigi_mcp::servers::ClientStateKind::Empty`]
...
use kigi_mcp::servers::{McpClientEventKind, McpServerName};
