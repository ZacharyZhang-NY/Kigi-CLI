...
//!
//! Mechanism (OS watch, coalesce, refcount) lives in `kigi_fsnotify`. This module
...
use kigi_workspace::file_system::{CodebaseIndexManager, FileIndex, WalkOptions};
use tokio::sync::mpsc;
...
fn fs_event_to_delta(
    ...
    kind: FsEventKind,
    root: &Path,
) -> kigi_workspace::file_system::FileIndexDelta {
