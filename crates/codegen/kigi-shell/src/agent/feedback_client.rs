...
// ============================================================================
// Turn delta wire types (local to kigi-shell until cli-chat-proxy catches up)
// ============================================================================
...
impl FeedbackClient {
    ...
    fn build_middleware_client(
        ...
        reqwest_middleware::ClientBuilder::new(http.clone())
            .with(kigi_auth::AuthRetryMiddleware::new(provider, 0))
            .build()
    }
    ...
    fn make_auth_provider(
        ...
        if let Some(am) = credentials.auth_manager() {
            ...
            Arc::new(kigi_auth::StaticAuthCredentialProvider::new(
    ...
    pub async fn try_refresh_credentials(&self) -> bool {
        ...
        manager.try_recover_unauthorized().await
    }
    ...
    fn add_common_headers(&self, builder: RequestBuilder) -> RequestBuilder {
        let builder = builder
            .header(CLIENT_VERSION_HEADER, kigi_version::VERSION)
            .header(
    ...
    async fn send_json<T: DeserializeOwned>(
        ...
        let request = kigi_file_utils::trace_context::inject_trace_context_into_request(request);
...
pub fn signals_to_update(
    ...
    SessionSignalsUpdate {
        ...
        // GCS upload queue removed (zero-egress build); keep its columns null.
        gcs_queue_enqueued: None,
        gcs_queue_uploaded: None,
        gcs_queue_failed: None,
        gcs_queue_fallbacks: None,
        gcs_queue_circuit_breaker_trips: None,
        gcs_queue_pending: None,
        gcs_queue_pending_bytes: None,
        gcs_queue_orphans_cleaned: None,
        // LOC Attribution
