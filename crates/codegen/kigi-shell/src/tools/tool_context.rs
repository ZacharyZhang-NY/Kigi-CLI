...
//! kigi-tools. This struct is NOT used for tool execution — it's session infrastructure.
//!
...
use kigi_workspace::file_system::{AsyncFileSystem, AsyncFsWrapper};
use kigi_workspace::session::file_state::FileStateHandle;
...
pub struct ToolContext {
    ...
    pub lsp: Option<Arc<dyn kigi_tools::implementations::lsp::LspBackend>>,
    ...
    pub monitor_event_buffer:
        Option<kigi_tools::implementations::grok_build::task::types::MonitorEventBuffer>,
...
impl ToolContext {
    pub fn new(
        ...
        let session_env = kigi_workspace::envrc::load_envrc_or_empty_when_trusted(
            cwd.as_path(),
