...
use super::agent_view::{
    AgentPane, AgentView, CONTEXT_CLICK_DEBOUNCE_MS, MULTI_CLICK_TIMEOUT_MS, PromptInputMode,
    TextClickState, app_should_open_link_on_click, has_native_link_hover, is_link_modifier_held,
