...
use super::{
    ActivePane, AgentPane, AgentView, AgentViewLayout, InlineMediaHitAreas, MODE_BANNER_FADE_TICKS,
    PromptMode, collect_citation_links, dropdown_items_width, render_dropdown_chrome,
    supports_osc22,
};
...
impl AgentView {
    ...
    pub fn draw(
        ...
        link_spans_out: &mut Vec<kigi_ratatui_inline::LinkSpan>,
    ) -> (
        Option<(u16, u16)>,
        Option<crate::terminal::overlay::PostFlush>,
    ) {
        ...
        if let Some(profile) = kigi_sandbox::profile_name() {
        ...
        self.pane_areas = layout.pane_areas();
        {
            ...
            if route.emit_osc8 {
                ...
                *link_spans_out = self
                    ...
                    .map(|link| kigi_ratatui_inline::LinkSpan {
                        row: link.screen_row,
