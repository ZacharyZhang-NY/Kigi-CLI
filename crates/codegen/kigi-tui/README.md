...
- [Hook Examples](../kigi-hooks/examples/README.md) — sample hooks for common workflows
- [Hooks Crate (`kigi-hooks`)](../kigi-hooks/) — hook runtime, event types, and execution engine
- [Plugin Marketplace Crate (`kigi-plugin-marketplace`)](../kigi-plugin-marketplace/) — marketplace source loading, scanning, and install
