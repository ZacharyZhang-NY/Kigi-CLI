...
/// Canonical permission-mode string for the recorded artifact. Matches
/// `config.ui.permission_mode` (hyphenated) for trace-internal consistency.
fn permission_mode_artifact_str(mode: kigi_config_types::PermissionMode) -> &'static str {
    use kigi_config_types::PermissionMode;
    match mode {
            ...
            match cmd {
                ...
                PermissionCommand::Request {
                    ...
                    let permission_mode = if yolo_mode {
                        kigi_config_types::PermissionMode::AlwaysApprove
                    } else if auto_mode {
                        kigi_config_types::PermissionMode::Auto
                    } else {
                        kigi_config_types::PermissionMode::Ask
                    };
                    ...
                    if matches!(&access, AccessKind::Bash(_))
                        && kigi_sandbox::should_auto_allow_bash()
...
mod tests {
    ...
    fn manager_with_recording_client_remember(
        ...
        let (gateway, receiver) = kigi_acp_lib::acp_gateway::<acp::AgentSide, _>(client);
